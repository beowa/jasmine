describe("j$.pp", function () {
  ...
  it("should stringify primitives properly", function() {
    ...
    expect(j$.pp(j$.undefined)).toEqual("undefined");
  ...
  it("should stringify arrays properly", function() {
    ...
    expect(j$.pp([1, 'foo', {}, j$.undefined, null])).toEqual("[ 1, 'foo', {  }, undefined, null ]");
  });
  ...
  it("should stringify objects properly", function() {
    ...
    expect(j$.pp({foo:'bar', baz:3, nullValue: null, undefinedValue: j$.undefined})).toEqual("{ foo : 'bar', baz : 3, nullValue : null, undefinedValue : undefined }");
  ...
  it("should abbreviate the global (usually window) object", function() {
    expect(j$.pp(j$.getGlobal())).toEqual("<global>");
  });
  ...
  it("should stringify objects that implement j$ToString", function () {
    var obj = {
